...
public class ServiceProperties {
	...
	private String name = "ChinikomContactService";

	@NotNull
	// you can also create configurationPropertiesValidator
	private String description = "Chinikom Contact Spring Boot MicroService using Spring Data JPA, Spring Cloud Learning";
